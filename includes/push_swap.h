...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/23 14:01:01 by bojamee           #+#    #+#             */
/*   Updated: 2021/08/23 14:01:07 by bojamee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef int		(*t_count_func)(t_element *);
typedef void	(*t_set_mark)(t_element *);
...
int			check_swap(t_element *a, int count, t_count_func calc_count,
				t_set_mark mark);
